...
try:
    conn = mysql.connector.connect(
           host='DiegoGMZ.mysql.pythonanywhere-services.com',
           user='DiegoGMZ',
           password='mysqlroot'
      )
...
cursor.execute("DROP DATABASE IF EXISTS `DiegoGMZ$pedidoEntrega`;")

cursor.execute("CREATE DATABASE `DiegoGMZ$pedidoEntrega`;")

cursor.execute("USE `DiegoGMZ$pedidoEntrega`;")
...
cursor.execute('select * from DiegoGMZ$pedidoEntrega.usuarios')
print(' -------------  Usuarios:  -------------')
...
cursor.execute('select * from DiegoGMZ$pedidoEntrega.productos')
print(' -------------  Productoss:  -------------')
